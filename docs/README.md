...
| [Attach accepted Chrome](ATTACH_EXISTING_CHROME.md) | The portal rejected the old Playwright-launched profile and you want to attach to a manually accepted Chrome session |
...
request. That includes challan statements, HAR files, taxpayer identifiers,
contact information, property addresses, credentials, and payment references.
